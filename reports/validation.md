...
|---|---:|---:|---:|---:|---:|---:|
| 01 | 0.1734 → 0.0044 | 0.0660 → 0.0286 | 0.2308 → 0.0077 | 0.0044 → 0.0011 | -0.0006（68） | 3.975 |
| 02 | 0.0275 → 0.0040 | 0.0246 → 0.0151 | 0.0346 → 0.0063 | 0.0031 → 0.0004 | -0.0001（57） | 3.375 |
| 03 | 0.0463 → 0.0145 | 0.0338 → 0.0103 | 0.0546 → 0.0236 | 0.0041 → 0.0044 | 0.0021（53） | 3.076 |
...
- V1 墙面中位值全片范围：0.0321。
- V3.4 墙面中位值全片范围：0.0017；相对 DepthPro 中位值偏差：0.0044。
