...
|---|---:|---:|---:|---:|---:|---:|
| 01 | 0.1734 → 0.0025 | 0.0660 → 0.0286 | 0.2308 → 0.0059 | 0.0044 → 0.0011 | -0.0006（68） | 3.315 |
| 02 | 0.0275 → 0.0017 | 0.0246 → 0.0151 | 0.0346 → 0.0034 | 0.0031 → 0.0003 | -0.0001（57） | 2.674 |
| 03 | 0.0463 → 0.0145 | 0.0338 → 0.0103 | 0.0546 → 0.0236 | 0.0041 → 0.0044 | 0.0021（53） | 2.747 |
...
- V1 墙面中位值全片范围：0.0321。
- V3.5 墙面中位值全片范围：0.0017；相对 DepthPro 中位值偏差：0.0044。
- 墙面静态权重 Laplacian P95：0.000001（越低表示网格分层越弱）。
