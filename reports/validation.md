...
|---|---:|---:|---:|---:|---:|---:|
| 01 | 0.1734 → 0.0122 | 0.0660 → 0.0504 | 0.2308 → 0.0177 | 0.0044 → 0.0012 | -0.0006（68） | 3.796 |
| 02 | 0.0275 → 0.0075 | 0.0246 → 0.0143 | 0.0346 → 0.0102 | 0.0031 → 0.0002 | -0.0002（57） | 2.323 |
| 03 | 0.0463 → 0.0145 | 0.0338 → 0.0101 | 0.0546 → 0.0235 | 0.0041 → 0.0044 | 0.0021（53） | 2.255 |
...
- V1 墙面中位值全片范围：0.0321。
- V3.2 墙面中位值全片范围：0.0014；相对 DepthPro 中位值偏差：0.0017。
